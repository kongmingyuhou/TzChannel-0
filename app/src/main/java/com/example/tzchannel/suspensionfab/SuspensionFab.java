...
import com.example.tzchannel.R;
import com.example.tzchannel.suspensionfab.manager.AnimationManager;
...
public class SuspensionFab extends RelativeLayout implements View.OnClickListener {
   ...
   /**
     ...
     *默认显示的按钮背景颜色
     */
    private int BackgroundTint= R.color.colorPrimary;
    ...
    private void init(Context context) {
        ...
        FabAttributes build = new FabAttributes.Builder()
                .setSrc(context.getResources().getDrawable(drawable_id))
